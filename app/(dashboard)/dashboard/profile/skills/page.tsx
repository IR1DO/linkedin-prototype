      ...
      <table className='border-collapse border-0'>
        ...
        <tbody>
          {usersToSkills.map((usersToSkill) => (
            <tr key={usersToSkill.skill.id}>
              <td className='border-slate-600 p-2 border-t'>
                {usersToSkill.skill.name}
              </td>
              <td className='border-slate-600 p-2 border-t'>
                <SkillRatingForm
                  rating={usersToSkill.rating || 0}
                  skillId={usersToSkill.skillId}
                />
              </td>
              <td className='border-slate-600 p-2 border-t'>
                <DeleteUserToSkillBtn skillId={usersToSkill.skillId} />
              </td>
            </tr>
          ))}
        </tbody>
